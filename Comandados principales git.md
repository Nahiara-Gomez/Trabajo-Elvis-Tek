...
git commit -m “Mi primer commit” → Con esto ya se guarda definitivamente en el historial los cambios realizados en el archivo. Y con el -m te permite hacer un comentario sobre el commit que se guardo.
